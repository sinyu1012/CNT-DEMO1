...
namespace 彩牛通
{
    public partial class CNTMainFrm : CCSkinMain
    {
        ...
        private void GetHelpRan()
        {
            ...
            setHelpColumnTwoNew();
            updateHelpDGV(dgv_help,help_randomTemps);
        }
        private void GetHelpRan2()
        {
            ...
            //setHelpAdditionalColumn();
            //setHelpColumnTwoNew();
            updateHelpDGV(dgv_help2, help2_randomTemps);
        }
        ...
        private void updateHelpDGV(DataGridView dgv, List<RandomTemp> rt)
        {
            dgv.Rows.Clear();
            int x = 0;
                    ...
                    for (int i = 0; i < randomTemps.Count && x < Help_ColumnRowCount; i++)
                    {
                        ...
                        if (!(randomTemps[i].ColumnNewOne.Equals("-1") || randomTemps[i].ColumnNewOne.Equals("-2")))
                        {
                            ...
                            //2018-5-4,新版本将辅助列以逗号拆分，生成两个方案
                                ...
                                temp.ColumnTwo = help_randomTemps[x].ColumnNewOne.ToString().Split(',')[0] +","+ help_randomTemps[x].ColumnNewOne.ToString().Split(',')[1] ;//辅助列
